...
register(
    ...
    entry_point='pybullet_envs.bullet:MinitaurBullet2Env',
    max_episode_steps=1000,
    reward_threshold=15.0,
)

register(
    id='MinitaurBulletCarryEnv-v0',
    entry_point='pybullet_envs.bullet:MinitaurBulletCarryEnv',
    max_episode_steps=1000,
    reward_threshold=15.0,
)

register(
    id='MinitaurBulletCarryEnv-v1',
    entry_point='pybullet_envs.bullet:MinitaurBulletCarry2Env',
    max_episode_steps=1000,
    reward_threshold=15.0,
)
#####
